 var Tag = {
	...
	url : "http://localhost/gordon/tags", /* url to script handling ajax for tags - modify path here */
	path: "http://localhost/gordon/tags/", /* url to tags-directory - modify path here */
